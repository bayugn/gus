...
# install v2ray
wget https://github.com/ohhmaigot/setupid/go.sh && chmod +x go.sh && ./go.sh
rm -f /root/go.sh
...
wget -O del-ws "https://github.com/ohhmaigot/setupid/del-ws.sh"
wget -O del-vless "https://github.com/ohhmaigot/setupid/del-vless.sh"
wget -O del-tr "https://github.com/ohhmaigot/setupid/del-tr.sh"
wget -O cek-ws "https://github.com/ohhmaigot/setupid/cek-ws.sh"
wget -O cek-vless "https://github.com/ohhmaigot/setupid/cek-vless.sh"
wget -O cek-tr "https://github.com/ohhmaigot/setupid/cek-tr.sh"
wget -O renew-ws "https://github.com/ohhmaigot/setupid/renew-ws.sh"
wget -O renew-vless "https://github.com/ohhmaigot/setupid/renew-vless.sh"
wget -O renew-tr "https://github.com/ohhmaigot/setupid/renew-tr.sh"
...
wget -O certv2ray "https://github.com/ohhmaigot/setupid/cert.sh"
wget -O menu "https://github.com/ohhmaigot/setupid/menu.sh"
wget -O bannermenu "https://github.com/ohhmaigot/setupid/bannermenu"
wget -O vvt "https://github.com/ohhmaigot/setupid/vvt.sh"
wget -O shadowsocks "https://github.com/ohhmaigot/setupid/shadowsocks.sh"
wget -O wireguard "https://github.com/ohhmaigot/setupid/wireguard.sh"
wget -O options "https://github.com/ohhmaigot/setupid/vvt-options.sh"
wget -O update "https://github.com/ohhmaigot/setupid/update.sh"
chmod +x add-ws
chmod +x add-vless
chmod +x add-tr
chmod +x del-ws
