...
# Tambahan
cd /usr/bin
wget -O add-wg "https://github.com/ohhmaigot/setupid/add-wg.sh"
wget -O del-wg "https://github.com/ohhmaigot/setupid/del-wg.sh"
wget -O cek-wg "https://github.com/ohhmaigot/setupid/cek-wg.sh"
wget -O renew-wg "https://github.com/ohhmaigot/setupid/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
