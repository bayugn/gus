...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://github.com/ohhmaigot/setupid/ssrmu"
...
Install_SSR
wget -O /usr/bin/ssr https://github.com/ohhmaigot/setupid/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/add-ssr https://github.com/ohhmaigot/setupid/add-ssr.sh && chmod +x /usr/bin/add-ssr
wget -O /usr/bin/del-ssr https://github.com/ohhmaigot/setupid/del-ssr.sh && chmod +x /usr/bin/del-ssr
wget -O /usr/bin/renew-ssr https://github.com/ohhmaigot/setupid/renew-ssr.sh && chmod +x /usr/bin/renew-ssr
