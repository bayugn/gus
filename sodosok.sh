...
cd /usr/bin
wget -O add-ss "https://github.com/ohhmaigot/setupid/add-ss.sh"
wget -O del-ss "https://github.com/ohhmaigot/setupid/del-ss.sh"
wget -O cek-ss "https://github.com/ohhmaigot/setupid/cek-ss.sh"
wget -O renew-ss "https://github.com/ohhmaigot/setupid/renew-ss.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x cek-ss
chmod +x renew-ss
