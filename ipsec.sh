...
wget -O /usr/bin/add-l2tp https://github.com/ohhmaigot/setupid/add-l2tp.sh && chmod +x /usr/bin/add-l2tp
wget -O /usr/bin/del-l2tp https://github.com/ohhmaigot/setupid/del-l2tp.sh && chmod +x /usr/bin/del-l2tp
wget -O /usr/bin/add-pptp https://github.com/ohhmaigot/setupid/add-pptp.sh && chmod +x /usr/bin/add-pptp
wget -O /usr/bin/del-pptp https://github.com/ohhmaigot/setupid/del-pptp.sh && chmod +x /usr/bin/del-pptp
wget -O /usr/bin/renew-pptp https://github.com/ohhmaigot/setupid/renew-pptp.sh && chmod +x /usr/bin/renew-pptp
wget -O /usr/bin/renew-l2tp https://github.com/ohhmaigot/setupid/renew-l2tp.sh && chmod +x /usr/bin/renew-l2tp
