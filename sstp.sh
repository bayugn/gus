...
wget -O /etc/accel-ppp.conf "https://github.com/ohhmaigot/setupid/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/add-sstp https://github.com/ohhmaigot/setupid/add-sstp.sh && chmod +x /usr/bin/add-sstp
wget -O /usr/bin/del-sstp https://github.com/ohhmaigot/setupid/del-sstp.sh && chmod +x /usr/bin/del-sstp
wget -O /usr/bin/cek-sstp https://github.com/ohhmaigot/setupid/cek-sstp.sh && chmod +x /usr/bin/cek-sstp
wget -O /usr/bin/renew-sstp https://github.com/ohhmaigot/setupid/renew-sstp.sh && chmod +x /usr/bin/renew-sstp
rm -f /root/sstp.sh
